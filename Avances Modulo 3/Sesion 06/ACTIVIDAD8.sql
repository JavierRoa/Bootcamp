...
INSERT INTO propiedad VALUES (1003,'01/03/2016','Vicu?a Mackenna 945',62,4,2,350000,70000,'A',82,12651346,12456905);
INSERT INTO propiedad VALUES (1004,'02/08/2009','Celerino Pereira 1567',73,3,1,375000,40000,'B',83,12116380,12466553);
INSERT INTO propiedad VALUES (1005,'02/01/2008','Vicu?a Mackena 285',62,3,2,600000,50000,'C',84,12885975,11745244);
...
INSERT INTO propiedad VALUES (1014,'20/05/'||TO_CHAR(SYSDATE,'YYYY'),'Tres Oriente N?6543',62,3,1,260000,NULL,'A',80,12064147,12466553);
...
INSERT INTO propiedad VALUES (1016,'01/02/2010','Pje. Caboz 2 Pedro Nu?ez 5879',45,2,1,160000,25000,'D',83,13071695,11630572);
...
select NRO_PROPIEDAD, FECHA_ENTREGA_PROPIEDAD 
  from PROPIEDAD 
    where FECHA_ENTREGA_PROPIEDAD like '&fecha' 
      ORDER BY FECHA_ENTREGA_PROPIEDAD;

select NRO_PROPIEDAD, FECINI_ARRIENDO 
  from PROPIEDAD_ARRENDADA 
    where FECINI_ARRIENDO like '&fecha' 
      order by FECINI_ARRIENDO;

select NUMRUT_CLI || '-' || DVRUT_CLI rut_cliente, 
NOMBRE_CLI || ' ' || APPATERNO_CLI || ' ' || APMATERNO_CLI NOMBRE_CLIENTE,
RENTA_CLI RENTA, FONOFIJO_CLI TELEFONO_FIJO, 
CELULAR_CLI CELULAR 
  from CLIENTE 
