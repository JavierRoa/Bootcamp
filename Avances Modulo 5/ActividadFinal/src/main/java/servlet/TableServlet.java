...
public class TableServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getSession().getAttribute("permiso").toString().equals("1")) {
			...
			request.getSession().setAttribute("orden", registroOrden.listar());
		}
		else {
			request.getSession().setAttribute("orden", registroOrden.listar(request.getSession().getAttribute("rutUsuario").toString()));
		}
